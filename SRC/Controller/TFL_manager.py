...
class TFLManager:
    ...
    @staticmethod
    def detect_light_sources_candidates(current_img):
    ...
    def run(self, id_frame, img_name):
        ...
        # part 2
        current_frame.traffic_light, current_frame.auxiliary = self.identifies_coordinates_of_traffic_lights(
            np.array(Image.open(img_name)), candidates, auxiliary)
